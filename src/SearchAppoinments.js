...
var SearchAppoinments = React.createClass({
                ...
                <div className="col-sm-offset-3 col-sm-6">
                    <div className="input-group">
                        ...
                        <div className="input-group-btn">
                            <button type="button" className="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Sort by: <span className="caret"></span></button>
...
module.exports = SearchAppoinments;
